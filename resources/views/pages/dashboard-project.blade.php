    ...
    <div class="pcoded-content">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card overflow-hidden borderless">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body widget-last-task">
                        <p class="m-b-15">New Dashboard <span class="float-right">5 Mins ago</span></p>
                        <ul class="list-unstyled m-b-25">
                            <li class="d-inline-block"><img src="assets/images/user/avatar-2.jpg" alt="user-image" class="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="assets/images/user/avatar-3.jpg" alt="user-image" class="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="assets/images/user/avatar-2.jpg" alt="user-image" class="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="assets/images/user/avatar-3.jpg" alt="user-image" class="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                        </ul>
                        <p class="m-b-15 ">Web Design <span class="float-right">8 Mins ago</span></p>
                        <ul class="list-unstyled  m-b-25">
                            <li class="d-inline-block"><img src="assets/images/user/avatar-2.jpg" alt="user-image" class="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="assets/images/user/avatar-2.jpg" alt="user-image" class="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="assets/images/user/avatar-3.jpg" alt="user-image" class="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                        </ul>
                        <p class="m-b-20">Android Design <span class="float-right">12 Mins ago</span></p>
                        <ul class="list-unstyled">
                            <li class="d-inline-block"><img src="assets/images/user/avatar-4.jpg" alt="user-image" class="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="assets/images/user/avatar-2.jpg" alt="user-image" class="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="assets/images/user/avatar-3.jpg" alt="user-image" class="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                        </ul>
                        <div class="input-group m-t-25">
                            <input type="text" name="task-insert" class="form-control" id="Project" placeholder="Add Project">
